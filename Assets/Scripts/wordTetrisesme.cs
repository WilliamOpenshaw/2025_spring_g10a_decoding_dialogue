...
public class wordTetrisesme : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        square0Sentence.GetComponent<TextMeshProUGUI>().text    =   "Good Morning."                 ;   //  Sentence 1
        long0Sentence.GetComponent<TextMeshProUGUI>().text      =   "Hi."                ;   //  Sentence 2
        zigzag0Sentence.GetComponent<TextMeshProUGUI>().text    =   "I am feeling"                  ;   //  Sentence 3 first half
        zigzag0Sentence2.GetComponent<TextMeshProUGUI>().text   =   "very hungry."                  ;   //  Sentence 3 second hal
        square1Sentence.GetComponent<TextMeshProUGUI>().text    =   "What do I want to eat?"                    ;   //  Sentence 4
        long1Sentence.GetComponent<TextMeshProUGUI>().text      =   "Sandwiches?"                    ;   //  Sentence 5        
        zigzag1Sentence.GetComponent<TextMeshProUGUI>().text    =   "Rice or"         ;   //  Sentence 6 first half        
        zigzag1Sentence2.GetComponent<TextMeshProUGUI>().text   =   "Burgers?"        ;   //  Sentence 6 second half        
        square2Sentence.GetComponent<TextMeshProUGUI>().text    =   "Everying is good."                    ;   //  Sentence 7
        long2Sentence.GetComponent<TextMeshProUGUI>().text      =   "I can't decide."                    ;   //  Sentence 8        
        zigzag2Sentence.GetComponent<TextMeshProUGUI>().text    =   "OK."         ;   //  Sentence 9 first half
        zigzag2Sentence2.GetComponent<TextMeshProUGUI>().text   =   "All right."        ;   //  Sentence 9 second half        
        square3Sentence.GetComponent<TextMeshProUGUI>().text    =   "Make the thing simple."                   ;   //  Sentence 10        
        long3Sentence.GetComponent<TextMeshProUGUI>().text      =   "Yes."                   ;   //  Sentence 11        
        zigzag3Sentence.GetComponent<TextMeshProUGUI>().text    =   "I decide"        ;   //  Sentence 12 first half        
        zigzag3Sentence2.GetComponent<TextMeshProUGUI>().text   =   "eat all of them."       ;   //  Sentence 12 second half        
        square4Sentence.GetComponent<TextMeshProUGUI>().text    =   "Wait."                   ;   //  Sentence 13
        long4Sentence.GetComponent<TextMeshProUGUI>().text      =   "I don't want to go out."                   ;   //  Sentence 14        
        zigzag4Sentence.GetComponent<TextMeshProUGUI>().text    =   "Let's"        ;   //  Sentence 15 first half        
        zigzag4Sentence2.GetComponent<TextMeshProUGUI>().text   =   "order UberEAT!"       ;   //  Sentence 15 second half 
