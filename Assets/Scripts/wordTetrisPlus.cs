...
public class wordTetrisPlus : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        square0Sentence.GetComponent<TextMeshProUGUI>().text    =   "Vive La France"                    ;   //  Sentence 1
        long0Sentence.GetComponent<TextMeshProUGUI>().text      =   "C'est la vie"                    ;   //  Sentence 2
        zigzag0Sentence.GetComponent<TextMeshProUGUI>().text    =   "I think,"         ;   //  Sentence 3 first half
        zigzag0Sentence2.GetComponent<TextMeshProUGUI>().text   =   "therefore I am."        ;   //  Sentence 3 second hal
        square1Sentence.GetComponent<TextMeshProUGUI>().text    =   "2+2 =5"                    ;   //  Sentence 4
        long1Sentence.GetComponent<TextMeshProUGUI>().text      =   "1984"                    ;   //  Sentence 5        
