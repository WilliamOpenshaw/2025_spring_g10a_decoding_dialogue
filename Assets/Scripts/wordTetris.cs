...
public class wordTetris : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        square0Sentence.GetComponent<TextMeshProUGUI>().text    =   "Stay gold, Ponyboy."                    ;   //  Sentence 1
        long0Sentence.GetComponent<TextMeshProUGUI>().text      =   "C'est la vie"                    ;   //  Sentence 2
        zigzag0Sentence.GetComponent<TextMeshProUGUI>().text    =   "Je pense,"         ;   //  Sentence 3 first half
        zigzag0Sentence2.GetComponent<TextMeshProUGUI>().text   =   "donc je suis."        ;   //  Sentence 3 second hal
        square1Sentence.GetComponent<TextMeshProUGUI>().text    =   "Chess isn't always competitive；it can be beautiful."                    ;   //  Sentence 4
        long1Sentence.GetComponent<TextMeshProUGUI>().text      =   "I want to be a polyglot."                    ;   //  Sentence 5        
        zigzag1Sentence.GetComponent<TextMeshProUGUI>().text    =   "It was the best of times,"         ;   //  Sentence 6 first half        
        zigzag1Sentence2.GetComponent<TextMeshProUGUI>().text   =   "it was the worst of times."        ;   //  Sentence 6 second half        
        square2Sentence.GetComponent<TextMeshProUGUI>().text    =   "Ignorance is strength."                    ;   //  Sentence 7
        long2Sentence.GetComponent<TextMeshProUGUI>().text      =   "Freedom is slavery."                    ;   //  Sentence 8        
        zigzag2Sentence.GetComponent<TextMeshProUGUI>().text    =   "War is peace."         ;   //  Sentence 9 first half
        zigzag2Sentence2.GetComponent<TextMeshProUGUI>().text   =   "Dominus illuminatio mea"        ;   //  Sentence 9 second half        
        square3Sentence.GetComponent<TextMeshProUGUI>().text    =   "I would rather have questions that can't be answered"                   ;   //  Sentence 10        
        long3Sentence.GetComponent<TextMeshProUGUI>().text      =   "than answers that can't be questioned."                   ;   //  Sentence 11        
        zigzag3Sentence.GetComponent<TextMeshProUGUI>().text    =   "All animals are equal,"        ;   //  Sentence 12 first half        
        zigzag3Sentence2.GetComponent<TextMeshProUGUI>().text   =   "but some are more equal than others."       ;   //  Sentence 12 second half        
        square4Sentence.GetComponent<TextMeshProUGUI>().text    =   "George Orwell makes political writing into art"                   ;   //  Sentence 13
        long4Sentence.GetComponent<TextMeshProUGUI>().text      =   "I want to learn chess openings."                   ;   //  Sentence 14        
        zigzag4Sentence.GetComponent<TextMeshProUGUI>().text    =   "If the unexamined life was not worth living,"        ;   //  Sentence 15 first half        
        zigzag4Sentence2.GetComponent<TextMeshProUGUI>().text   =   "was the unlived life worth examining?"       ;   //  Sentence 15 second half 
